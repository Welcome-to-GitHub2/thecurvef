...
export default function MatricResults() {
  ...
  const handleCheck = () => {
    alert("Checking results for exam number: " + examNumber + ". (Placeholder - redirect to official site)");
  };

  return (
    <section className="bg-[#0F4C5C] min-h-screen flex flex-col items-center justify-center px-6 py-12 text-white text-center">
      ...
      <div className="max-w-3xl w-full bg-[#1a5c70]/70 p-10 rounded-xl shadow-2xl mb-16">
        ...
        <p className="text-lg mb-8">
          The easiest way! Receive your results directly on WhatsApp or SMS when released.
        </p>
